...
public class WebEventlistner extends BaseClass implements WebDriverEventListener {
	...
	public void afterClickOn(WebElement ele, WebDriver driver) {
		System.out.println("After click on "+ ele + driver);
	...
	public void afterNavigateTo(String url, WebDriver driver) {
		System.out.println("After click on " + url);		
	}
	...
	public void beforeClickOn(WebElement ele, WebDriver driver) {
		...
		System.out.println("Before click on "+ ele+ driver);
	...
	public void beforeNavigateTo(String url, WebDriver driver) {
		System.out.println("Before navigateed to " + url);		
	}
